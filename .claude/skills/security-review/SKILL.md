...
Antes de agir, leia integralmente `docs/skills/security-review.md` e `docs/rules.md`. A definição canônica está no primeiro arquivo; este adaptador não acrescenta regras.
