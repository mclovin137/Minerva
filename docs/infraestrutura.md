...
Este arquivo não escolhe provedor, topologia, serviço ou ferramenta. Decisão de infraestrutura segue `docs/rules.md`, a regra de custo financeiro zero e a atualização correspondente da base Obsidian.
